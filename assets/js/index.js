...
const createGrid = activities
  .map(
    activity =>
      `<li data-category=${activity.category} data-neighborhood=${activity.neighborhood}>
  <h2 class="activity-name">${activity.name}</h2>
  <div class="activity-map"><a href="${activity.directions}"><i class="fas fa-map-marker-alt"></i></a> </div>
  </li>
  `
  )
  .join("");
